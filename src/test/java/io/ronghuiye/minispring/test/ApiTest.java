...
public class ApiTest {
    ...
    public void test_BeanFactory() {
        ...
        UserService userService = (UserService) beanFactory.getBean("userService", "ryan");
...
//need to add vm arg(--add-opens java.base/java.lang=ALL-UNNAMED) in java18
    ...
    public void test_cglib() {
        ...
        Object obj = enhancer.create(new Class[]{String.class}, new Object[]{"ryan"});
    ...
    public void test_parameterTypes() throws Exception {
        ...
        UserService userService = declaredConstructor.newInstance("ryan");
